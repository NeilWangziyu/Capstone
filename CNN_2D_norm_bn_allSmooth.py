...
from keras.layers import Dense, Activation, Convolution2D, MaxPooling2D, Flatten,Dropout, Convolution1D,MaxPooling1D, BatchNormalization
    ...
    if filename.endswith('.csv') :
      ...
      if signal_paths[0]:
        ...
        for i in range(0, len(cutpoint) - 1):
            ...
            gesture_emg8_bspline_abs = butter_lowpass_filter(gesture_emg8_bspline_abs, cutoff, fs)
...
model.save('my_CNN_model_2D_norm_bn_allSmooth.h5')
print('model is saved as my_CNN_model_2D_norm_bn_allSmooth.h5')
